...
<code-snippet name="Route Parameter vs Model Binding Example" lang="blade">
...
<code-snippet name="Inline Query Example in a Folio Page" lang="blade">
...
<code-snippet name="Render Hook Example for View Data" lang="php">
